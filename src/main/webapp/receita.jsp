...
<head>
    ...
    <title>Future Planner: Receitas</title>
...
<div class="d-grid gap-4 col-3 mx-auto">
    <h1 class="title">Cadastrar Receita</h1>

 
        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample1"
                    aria-expanded="false" aria-controls="multiCollapseExample1">Nova Receita
        </button>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
        <div class="card card-body">
            <form class="row g-3 needs-validation was-validated" novalidate=""
                  action="receita-servlet" method="post">
...
<div class="d-grid gap-4 col-3 mx-auto mt-4">
    <h4 class="title">Minhas Receitas</h4>
    <table class="table table-striped table-bordered table-gray">
        ...
        <c:forEach var="receita" items="${ listaReceitas }">
            <tr>
                <td colspan="2" class="table-active">${receita.codigo}</td>
                <td colspan="2" class="table-active">${receita.descricao}</td>
                <td colspan="2" class="table-active">${receita.valor}</td>
            </tr>
        </c:forEach>
    </table>
</div>
